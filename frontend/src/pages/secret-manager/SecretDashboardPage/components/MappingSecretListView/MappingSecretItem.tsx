...
import { TGetSecretAndMappingSecretDTO } from "@app/hooks/api";
import { SecretRotationSecretRow } from "./MappingSecretSecretRow";

type Props = {
  mappingSecret: TGetSecretAndMappingSecretDTO;
  onEdit: () => void;
  onRotate: () => void;
...
export const MappingSecretItem = ({
  mappingSecret,
  onEdit,
  onRotate,
