...
import { SecretEditRow } from "../SecretOverviewTableRow/SecretEditRow";
import SecretRenameRow from "../SecretOverviewTableRow/SecretRenameRow";
...
type Props = {
  ...
  setIsFormExpanded: { toggle: () => void };
  isSecretVisible: boolean;
  setIsSecretVisible: { toggle: () => void };
  folderName: string;
};

export const SecretSameValueRow = ({
  secretKey,
  environments = [],
  secretPath,
  getSecretByKey,
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              <div
                                title={name}
                                className="flex h-8 w-[8rem] items-center space-x-2"
                              >
